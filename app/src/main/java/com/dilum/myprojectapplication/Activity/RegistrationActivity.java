...
import com.dilum.myprojectapplication.Models.UserModel;
        ...
        signUp.setOnClickListener(new View.OnClickListener() {
            ...
            private void createUser() {
                ...
                if (userPassword.length() < 6){
                    Toast.makeText(RegistrationActivity.this, "Password Lenth must exceeed 6 letters", Toast.LENGTH_SHORT).show();
                    return;
                }
